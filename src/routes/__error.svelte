...
<section class="container prose mx-auto py-12 dark:prose-invert">
	...
	{#if status === 404}
		<p class="">There is no post at the slug (URL) <code>{url.pathname}</code>.</p>
		<!--		<p><a href={'/ideas/?filter=' + url.pathname.slice(1)}>Try searching for it here!</a></p> -->
		<p class="">If you believe this was a bug, please let me know! Email alex.lee [at] ucsf.edu</p>
	{:else}
