...
<!-- 	<img
		src="/static/testoutput.webp"
		alt="A video of a protein wiggling around."
		class="right scale-y-50 scale-x-50 bg-transparent opacity-90 brightness-75 dark:bg-transparent dark:opacity-100 dark:brightness-100 xl:left-0 xl:bottom-7"
	/>
-->
...
>
	<div class="flex flex-col-reverse items-start sm:flex-row">
		<div class="flex flex-col pr-8">
			<h1 class="mb-3 text-2xl font-bold tracking-tight text-black dark:text-white md:text-6xl">
				Hi, my name is

				<span
					class="relative ml-2 inline-block before:absolute before:-inset-1 before:block before:-skew-y-3 before:bg-tahiti"
				>
					<span class="text-white-400 relative skew-y-3">Alex</span>
				</span>
				!
			</h1>
			<h2 class="mb-4 text-gray-700 dark:text-gray-200">
				and I'm a PhD student in bioinformatics at UCSF. <span class="font-semibold" />
			</h2>
		</div>
		<!-- <div
	...
	<section class="mb-16 w-full">
		...
		<div class="flex flex-col gap-6 md:flex-row">
			...
			<!-- <FeatureCard
				...
				href="/content/attention-across-datapoints"
				stringData="Jan 2022"
			/> -->
		</div>
		<a
